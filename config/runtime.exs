...
#
#     PHX_SERVER=true bin/slack_messenger start
#
...
if config_env() == :prod do
  ...
  config :slack_messenger, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :slack_messenger, SlackMessenger.Mailer,
